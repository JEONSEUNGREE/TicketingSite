package com.massive.flow.service;
...
import com.massive.flow.exception.ErrorCode;
...
public class UserQueueService {
	...
	public Mono<Long > registerWaitQueue(final String queue, final Long userId) {
		// redis sortedset
		// - key: userId
		// - value: unix timestamp 먼저 등록한 사람을 알아내서 스코어를 sortedset으로 저장
